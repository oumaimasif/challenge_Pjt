...
export default function DemandeAideCard({ demande, onSelectDemande }) {
  ...
  return (
    <div className="relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
      <div className={`absolute top-0 left-0 z-10 bg-purple-200 text-gray-700 font-semibold py-1 px-2 rounded-br-xl flex items-center`}>
        <AlertCircle className="w-5 h-5" />
        <span className="text-gray-700 font-semibold w-min py-1 px-2 rounded-br-2xl"> Demande d'aide </span>
      </div>
      ...
      <div className="space-y-3 p-4">
        ...
        <button
          ...
          className="block w-full mt-4 text-center bg-violet-500 text-white py-2 rounded-full hover:bg-violet-600 transition-all duration-300 hover:shadow-lg"
        >
          Voir les détails
        </button>
      </div>
