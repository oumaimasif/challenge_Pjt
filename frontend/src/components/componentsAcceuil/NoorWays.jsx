...
function NoorWays() {
  return (
    <>
    <section className='bg-orange-100 mx-5 rounded-2xl py-8 mb-3'>
    <div className='max-w-fullm mt-32 mx-44  min-h-svh  space-y-2 '>
      ...
      <div className='p-8 grid grid-flow-col mr-8 gap-8 grid-cols-3'>
      <div className=' bg-white p-5 space-y-4  ' >
          ...
          <button className='bg-purple-800 text-white p-2 rounded-lg'>Trouver des Bén2voles</button>
        </div>
         <div className=' bg-white p-5 space-y-4 ' >
